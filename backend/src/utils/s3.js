        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    uniqueFileName = "".concat(Date.now(), "_").concat(fileName.replace(/\s+/g, "_"));
                ...
                case 1:
                    ...
                    return [2 /*return*/, "https://".concat(bucketName, ".s3.").concat(region, ".amazonaws.com/").concat(uniqueFileName)];
            }
        });
    });
}
