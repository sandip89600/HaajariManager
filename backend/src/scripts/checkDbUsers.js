...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var mongoUri, count, sampleUsers, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mongoUri = process.env.MONGO_URI || "mongodb://localhost:27017/haajari";
                    _a.label = 1;
                case 1:
                ...
                case 3:
                    count = _a.sent();
                    console.log("Total users in database: ".concat(count));
                    if (!(count > 0)) return [3 /*break*/, 5];
                    return [4 /*yield*/, models_1.User.find({}, "name phone email role biometricEnabled").limit(5)];
                case 4:
                    sampleUsers = _a.sent();
                ...
                case 7:
                    err_1 = _a.sent();
                    console.error("Database connection/query failed:", err_1.message);
                    return [3 /*break*/, 10];
