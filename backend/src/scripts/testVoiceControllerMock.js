...
function runMockController() {
    return __awaiter(this, void 0, void 0, function () {
        var mongoUri, err_1, mockReq, mockRes, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mongoUri = process.env.MONGO_URI;
                    if (!mongoUri) return [3 /*break*/, 4];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    err_1 = _a.sent();
                    console.warn("MongoDB connection failed, proceeding offline:", err_1);
                    return [3 /*break*/, 4];
                case 4:
                    mockReq = {
                        user: {
                            id: new mongoose_1.default.Types.ObjectId().toString(),
                            tenantId: new mongoose_1.default.Types.ObjectId().toString(),
                        },
                        body: {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, voiceController_1.processVoiceCommand)(mockReq, mockRes)];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 7:
