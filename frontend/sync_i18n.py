...
languages = {
    "en": {"name": "English", "app_name": "Haajari", "tagline": "Powered by Haajari Artificial Intelligence", "attendance": "Attendance", "workers": "Workers", "summary": "Summary", "settings": "Settings", "save": "Save", "cancel": "Cancel", "delete": "Delete", "edit": "Edit", "present": "P", "absent": "A"},
    "hi": {"name": "हिन्दी (Hindi)", "app_name": "Haajari", "tagline": "हाजरी आर्टिफिशियल इंटेलिजेंस द्वारा संचालित", "attendance": "हाजरी", "workers": "कामगार", "summary": "सारांश", "settings": "सेटिंग्स", "save": "सुरक्षित करें", "cancel": "रद्द करें", "delete": "हटाएं", "edit": "संपादित करें", "present": "उ", "absent": "ग"},
    "bn": {"name": "বাংলা (Bengali)", "app_name": "Haajari", "tagline": "হাজরি কৃত্রিম বুদ্ধিমত্তা দ্বারা চালিত", "attendance": "হাজিরা", "workers": "কর্মী", "summary": "সারসংক্ষেপ", "settings": "সেটিংস", "save": "সংরক্ষণ", "cancel": "বাতিল", "delete": "মুছে ফেলুন", "edit": "সম্পাদনা", "present": "উ", "absent": "অনুপ"},
    "te": {"name": "తెలుగు (Telugu)", "app_name": "Haajari", "tagline": "హాజరు కృత్రిమ మేధస్సుతో పనిచేస్తుంది", "attendance": "హాజరు", "workers": "కార్మికులు", "summary": "సారాంశం", "settings": "సెట్టింగులు", "save": "சேவ்", "cancel": "రద్దు", "delete": "తొలగించు", "edit": "సవరించు", "present": "హా", "absent": "గే"},
    "mr": {"name": "मराठी (Marathi)", "app_name": "Haajari", "tagline": "हाजरी आर्टिफिशियल इंटेलिजन्सद्वारे संचालित", "attendance": "हजेरी", "workers": "कामगार", "summary": "सारांश", "settings": "सेटिंग्ज", "save": "जतन करा", "cancel": "रद्द करा", "delete": "काढून टाका", "edit": "संपादन", "present": "ह", "absent": "गै"},
    "ta": {"name": "தமிழ் (Tamil)", "app_name": "Haajari", "tagline": "ஹாஜரி செயற்கை நுண்ணறிவு மூலம் இயக்கப்படுகிறது", "attendance": "வருகை", "workers": "தொழிலாளர்கள்", "summary": "சுருக்கம்", "settings": "அமைப்புகள்", "save": "சேமி", "cancel": "ரத்து", "delete": "அழி", "edit": "திருத்து", "present": "வ", "absent": "இ"},
    "gu": {"name": "ગુજરાતી (Gujarati)", "app_name": "Haajari", "tagline": "હાજરી કૃત્રિમ બુદ્ધિમત્તા દ્વારા સંચાલિત", "attendance": "હાજરી", "workers": "કામદારો", "summary": "સારાંશ", "settings": "સેટિંગ્સ", "save": "સાચવો", "cancel": "રદ કરો", "delete": "કાઢી નાખો", "edit": "ફેરફાર કરો", "present": "હા", "absent": "ગેર"},
    "kn": {"name": "ಕನ್ನಡ (Kannada)", "app_name": "Haajari", "tagline": "ಹಾಜರಾತಿ ಕೃತಕ ಬುದ್ಧಿಮತ್ತೆಯಿಂದ ಚಾಲಿತವಾಗಿದೆ", "attendance": "ಹಾಜರಾತಿ", "workers": "ಕಾರ್ಮಿಕರು", "summary": "ಸಾರಾಂಶ", "settings": "ಸೆಟ್ಟಿಂಗ್‌ಗಳು", "save": "ಉಳಿಸು", "cancel": "ರದ್ದು", "delete": "ಅಳಿಸು", "edit": "ಮಾರ್ಪಡಿಸು", "present": "ಹಾ", "absent": "ಗೈ"},
    "ml": {"name": "മലയാളം (Malayalam)", "app_name": "Haajari", "tagline": "ಹಾജർ കൃത്രിമ ബുദ്ധി ഉപയോഗിച്ച് പ്രവർത്തിക്കുന്നു", "attendance": "ഹാജർ", "workers": "തൊഴിലാളികൾ", "summary": "സംഗ്രഹം", "settings": "ക്രമീകരണങ്ങൾ", "save": "സംരക്ഷിക്കുക", "cancel": "റദ്ദാക്കുക", "delete": "ഇല്ലാതാക്കുക", "edit": "തിരുത്തുക", "present": "ഹാ", "absent": "അ"},
    "pa": {"name": "ਪੰਜਾਬੀ (Punjabi)", "app_name": "Haajari", "tagline": "ਆਰਟੀਫਿਸ਼ੀਅਲ ਇੰਟੈਲੀਜੈਂਸ ਦੁਆਰਾ ਸੰਚਾਲਿਤ", "attendance": "ਹਾਜ਼ਰੀ", "workers": "ਕਾਮੇ", "summary": "ਸਾਰਾਂਸ਼", "settings": "ਸੈਟਿੰਗਾਂ", "save": "ਸੁਰੱਖਿਅਤ ਕਰੋ", "cancel": "ਰੱਦ ਕਰੋ", "delete": "ਮਿਟਾਓ", "edit": "ਸੋਧੋ", "present": "ਹਾ", "absent": "ਗੈ"},
    "or": {"name": "ଓଡ଼ିଆ (Odia)", "app_name": "Haajari", "tagline": "ଆର୍ଟିଫିସିଆଲ୍ ଇଣ୍ଟେଲିଜେନ୍ସ ଦ୍ୱାରਾ ଚାଲିତ", "attendance": "ହାଜିରା", "workers": "କର୍ମଚାରୀ", "summary": "ସାରାଂଶ", "settings": "ସେଟିଂସଙ୍ग୍", "save": "ସଂରକ୍ଷଣ", "cancel": "ବାତିଲ୍", "delete": "ଲିଭାନ୍ତុ", "edit": "ସଂଶୋଧନ", "present": "ଉ", "absent": "ଅ"},
    "as": {"name": "অসমীয়া (Assamese)", "app_name": "Haajari", "tagline": "হাজিৰা কৃত্ৰিম বুদ্ধিমত্তা দ্বাৰা চালিত", "attendance": "হাজিৰা", "workers": "কৰ্মী", "summary": "সাৰাংশ", "settings": "ছেটিংছ", "save": "সংৰক্ষণ", "cancel": "বাতিল", "delete": "মুচি পেলাওক", "edit": "সম্পাদনা", "present": "উপ", "absent": "অনুপ"},
    "ur": {"name": "اردو (Urdu)", "app_name": "Haajari", "tagline": "حاضری مصنوعی ذہانت کے ذریعے چلتی ہے", "attendance": "حاضری", "workers": "مزدور", "summary": "خلاصہ", "settings": "ترتیبات", "save": "محفوظ کریں", "cancel": "منسوخ کریں", "delete": "حذف کریں", "edit": "ترمیم کریں", "present": "حا", "absent": "غ"},
    "sa": {"name": "संस्कृतम् (Sanskrit)", "app_name": "Haajari", "tagline": "कृत्रिम बुद्धिमत्ता सञ्चालित हाजिरी", "attendance": "उपस्थिति:", "workers": "कर्मकरा:", "summary": "सारांश:", "settings": "विन्यास:", "save": "रक्षितुम्", "cancel": "निरस्तम्", "delete": "लोपयतु", "edit": "परिवर्तयतु", "present": "उ", "absent": "अ"},
    "ne": {"name": "नेपाली (Nepali)", "app_name": "Haajari", "tagline": "हाजिरी कृत्रिम बुद्धिमत्ता द्वारा संचालित", "attendance": "हाजिरी", "workers": "कामदार", "summary": "सारांश", "settings": "सेटिङहरू", "save": "बचत गर्नुहोस्", "cancel": "रद्द गर्नुहोस्", "delete": "হटाउनुहोस्", "edit": "सम्पादन गर्नुहोस्", "present": "उ", "absent": "ग"},
    "kok": {"name": "कोंकणी (Konkani)", "app_name": "Haajari", "tagline": "हाजरी कृत्रिम बुद्धिमत्ता वर चालपी", "attendance": "हाजरी", "workers": "कामगार", "summary": "सारांश", "settings": "मांडणी", "save": "सांबाळचें", "cancel": "रद्द करचें", "delete": "काडून उडोवचें", "edit": "बदलचें", "present": "ह", "absent": "ना"},
    "mai": {"name": "मैथिली (Maithili)", "app_name": "Haajari", "tagline": "हाजिरी कृत्रिम बुद्धिमत्ता द्वारा संचालित", "attendance": "हाजिरी", "workers": "कामगार", "summary": "सारांश", "settings": "सेटिंग्स", "save": "सुरक्षित करू", "cancel": "रद्द करू", "delete": "मेटाऊ", "edit": "संशोधित करू", "present": "उ", "absent": "अ"},
    "doi": {"name": "डोगरी (Dogri)", "app_name": "Haajari", "tagline": "हाजरी कृत्रिम बुद्धिमत्ता कन्नै चलदी", "attendance": "हाजरी", "workers": "कामगार", "summary": "सारांश", "settings": "सेटिंग्स", "save": "बचाओ", "cancel": "रद्द करो", "delete": "हटाओ", "edit": "बदलो", "present": "हा", "absent": "गैर"},
    "sat": {"name": "संथाली (Santali)", "app_name": "Haajari", "tagline": "ᱦᱟᱡᱤᱨᱤ ᱟᱨᱴᱤᱯᱷᱤᱥᱤᱭaᱞ ᱤᱱᱴᱮᱞᱤᱡᱮᱱᱥ ᱛᱮ ᱪᱟᱞᱟᱣ", "attendance": "ᱦᱟᱡᱤᱨᱤ", "workers": "ᱠᱟᱹᱢᱤᱭᱟᱹ", "summary": "ᱥᱟᱨᱟᱝᱥ", "settings": "ᱥᱮᱴᱤᱝᱥ", "save": "ᱵᱟᱧᱪａᱣ", "cancel": "ᱵᱟᱹᱛｉｌ", "delete": "ᱜᱤᱰᱤ", "edit": "ᱵᱚᱫᱚ防", "present": "ᱥᱮ", "absent": "ᱵᱟ"},
    "ks": {"name": "कश्मीरी (Kashmiri)", "app_name": "Haajari", "tagline": "ہاضری مصنوعی ذہانت پٹھ چلان", "attendance": "ہاضری", "workers": "مزدور", "summary": "خلاصہ", "settings": "سیٹنگس", "save": "بچاو", "cancel": "منसूخ", "delete": "حذف", "edit": "تبدیل", "present": "حا", "absent": "غ"},
    "sd": {"name": "सिंधी (Sindhi)", "app_name": "Haajari", "tagline": "حاضري مصنوعي ذهانت ذريعي هلندڙ", "attendance": "حاضري", "workers": "مزدور", "summary": "خلاصو", "settings": "سيٽنگون", "save": "محفوظ ڪريو", "cancel": "رد ڪريو", "delete": "خارج ڪريو", "edit": "تبديل ڪريو", "present": "حا", "absent": "غي"},
    "mni": {"name": "मणिपुरी (Manipuri)", "app_name": "Haajari", "tagline": "হাজিৰি আরতিফিসিয়েল ইন্টেলিজেন্সনা চলাইবা", "attendance": "হাজিৰি", "workers": "থবক শুবা", "summary": "শিংলুপ", "settings": "সেত্তিংস", "save": "সেভ তৌবা", "cancel": "কেন্সেল", "delete": "মুথতপা", "edit": "শেমদোকপা", "present": "লৈ", "absent": "লৈতা"}
}
