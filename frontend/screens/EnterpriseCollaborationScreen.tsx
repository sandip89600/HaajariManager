...
export default function EnterpriseCollaborationScreen() {
  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      body: "Ramesh Kumar added to site project Alpha.",
      priority: "medium",
      isRead: false,
      time: "10 mins ago",
    },
    {
      ...
      body: "Site Beta marked as In Progress.",
      priority: "high",
      isRead: false,
      time: "1 hr ago",
    },
    {
      ...
      body: "Wages of ₹12,500 marked paid for Mistri Ramesh.",
      priority: "low",
      isRead: true,
      time: "Yesterday",
    },
  ...
  const [documents, setDocuments] = useState([
    {
      id: "doc-1",
      title: "Structural Slab Blueprint",
      category: "Construction Drawings",
      uploadedBy: "Supervisor Sunil",
      size: "4.8 MB",
      date: "2026-07-20",
    },
    {
      id: "doc-2",
      title: "UltraTech Cement Invoice",
      category: "Invoices",
      uploadedBy: "Accountant Vinay",
      size: "1.2 MB",
      date: "2026-07-24",
    },
    {
      id: "doc-3",
      title: "Site Foundation Progress Photo",
  ...
  const [approvals, setApprovals] = useState([
    {
      ...
      requester: "Supervisor Sunil",
      desc: "Change worker Ramesh status from Absent to Present on 24th July.",
      status: "Pending",
    },
    {
      id: "app-2",
      type: "Expense Approval",
      requester: "Accountant Vinay",
      desc: "Approve machinery rent expense of ₹15,000 for slab lift.",
      status: "Pending",
    },
    {
      id: "app-3",
      type: "Worker Transfer",
      requester: "Contractor Hari",
      desc: "Relocate 3 labourers from Site Alpha to Site Beta.",
      status: "Approved",
    },
  ]);
  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      user: "Accountant Vinay",
      time: "08:45 AM",
      date: "2026-07-27",
      target: "UltraTech Invoice",
    },
  ];
  ...
  const auditLogs = [
    {
      actor: "Contractor Hari",
      action: "Deleted Payment Log",
      details: "Wages of ₹3,000 removed for Ramesh Kumar.",
    ...
    },
    {
      ...
      date: "2026-07-26 06:15 PM",
    },
    {
      actor: "Supervisor Sunil",
      action: "Edited Attendance Log",
      details: "Site Alpha attendance revised.",
      date: "2026-07-25 10:20 AM",
    },
  ];
  ...
  const handleBackupDb = () => {
    ...
    Alert.alert(
      "Database Backup",
      "Manual backup payload generated and saved to Local Secure Cache.",
    );
  };
  ...
  const handleRestoreDb = () => {
    ...
    Alert.alert(
      "Database Restore",
      "Warning: Restoring will overwrite local modifications. Proceed?",
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Restore",
          onPress: () =>
            Alert.alert("Success", "Database state restored successfully."),
        },
      ],
    );
  };
      ...
      <View style={[styles.header, { borderBottomColor: theme.border }]}>
        ...
        <View style={{ flex: 1, marginLeft: 8 }}>
          ...
          <ThemedText style={styles.headerSubtitle}>
            Collaboration, Documents & Operations
          </ThemedText>
        </View>
      </View>
      ...
      >
        ...
        {activeTab === "notifications" && (
          <View>
            ...
            >
              <ThemedText style={styles.secTitle}>
              ...
              >
                ...
                >
                  ...
                  <ThemedText
                    style={{
                      fontSize: 11,
                      fontWeight: "700",
                      color: app.status === "Pending" ? "#D97706" : "#10B981",
                    }}
                  >
                    {app.status}
                  </ThemedText>
                ...
                {app.status === "Pending" && (
                  <View style={styles.actionRowBtn}>
                    <Pressable
                      onPress={() => handleApprove(app.id, "Approved")}
                    ...
                    <Pressable
                      onPress={() => handleApprove(app.id, "Rejected")}
              ...
              <View key={idx} style={styles.timelineRow}>
                ...
                <View style={styles.timelineContent}>
                  ...
                  <ThemedText style={styles.timelineDesc}>
                    Triggered by {evt.user} for {evt.target}
                  </ThemedText>
        ...
        {activeTab === "company" && (
          ...
          >
            <ThemedText style={styles.secTitle}>
              Multi-Company Profile Settings
            </ThemedText>
            <View style={styles.profileRow}>
              <ThemedText style={styles.profileLabel}>
                Company Legal Name
              </ThemedText>
              <ThemedText style={styles.profileVal}>
                {companyProfile.name}
              </ThemedText>
            </View>
            <View style={styles.profileRow}>
            ...
            <View style={styles.profileRow}>
              ...
              >
                <ThemedText
                  style={{ color: "#1E40AF", fontWeight: "700", fontSize: 10 }}
                >
                  {companyProfile.plan.toUpperCase()}
                </ThemedText>
              </View>
            </View>
          </View>
        ...
        {activeTab === "backup" && (
          ...
          >
            ...
            <ThemedText style={{ fontSize: 12, opacity: 0.8, lineHeight: 18 }}>
              Export your local database state as a JSON file, or restore
              previously archived settings files.
            </ThemedText>

            <Pressable
              onPress={handleBackupDb}
              style={[
                styles.btnActionLarge,
                { backgroundColor: theme.primary },
              ]}
            >
