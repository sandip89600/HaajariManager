...
function getEventIcon(type: string): { name: any; color: string } {
  switch (type) {
    ...
    case "LOGOUT_ALL_DEVICES":
      return { name: "shield-off", color: "#6B7280" };
    case "LOGIN":
...
function getEventLabel(type: string): string {
  switch (type) {
    ...
    case "SECURITY_ALERT_SUSPICIOUS":
      return "Suspicious Login Reported";
    case "DEVICE_REVOKED":
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      <View style={styles.eventHeader}>
                        <ThemedText
                          style={[styles.eventLabel, { color: theme.text }]}
                        >
                          {label}
                        </ThemedText>
                        <ThemedText
                      ...
                      {(ev.deviceName || ev.details) && (
                        ...
                        >
                          {ev.deviceName
                            ? `${ev.deviceName}${ev.platform ? " • " + ev.platform : ""}${ev.location ? " • " + ev.location : ""}`
                            : ev.details}
                        </ThemedText>
                      )}
