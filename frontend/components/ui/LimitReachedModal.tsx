      ...
      <View style={styles.overlay}>
        ...
        >
          ...
          <ThemedText style={styles.subtitle}>
            Upgrade to continue growing your business. Tap upgrade below to see
          ...
          >
            ...
            <View style={styles.featureRow}>
              ...
              <ThemedText style={styles.featureText}>
                More Workers (Up to unlimited)
              </ThemedText>
            </View>
            <View style={styles.featureRow}>
              <Ionicons name="checkmark-circle" size={16} color="#22C55E" />
              <ThemedText style={styles.featureText}>
                More Sites (Manage unlimited projects)
              </ThemedText>
            </View>
            <View style={styles.featureRow}>
              <Ionicons name="checkmark-circle" size={16} color="#22C55E" />
            ...
            <View style={styles.featureRow}>
              <Ionicons name="checkmark-circle" size={16} color="#22C55E" />
              <ThemedText style={styles.featureText}>
                Salary, Payments & Expenses tracking
              </ThemedText>
            </View>
          </View>
          ...
          <View style={styles.actionRow}>
            ...
            <Pressable
              ...
              style={[styles.btn, styles.upgradeBtn]}
            >
