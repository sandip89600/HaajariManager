    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Audit worker daily wage payroll distributions and outstanding
            liabilities
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-850 flex items-center justify-between">
          <div>
            <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">
              Outstanding Wages Due
            </p>
            <h3 className="text-2xl font-bold text-rose-455">
              ...
              {filteredSalaries.length > 0 ? (
                filteredSalaries.map((s) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-extrabold text-rose-450">
