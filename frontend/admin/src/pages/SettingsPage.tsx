    ...
    queryFn: async () => {
      try {
        ...
        return {
          ...
          mfaEnabled: true,
          smsTemplate:
            "Hi {workerName}, your attendance for {date} is marked as {status}.",
          gstRate: 18,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          Configure global server flags, notification gateways, and security
          parameters
        </p>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                    ...
                    <span className="text-[10px] text-slate-500 block">
                      Required for invoice calculations. Default is 18% GST.
                    </span>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    />
                    <span className="text-[10px] text-slate-500 block">
                      Tolerance boundary for marking location-based attendance.
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-slate-400 font-medium">
                      Redirect all traffic to system offline maintenance page
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="text-xs text-slate-400 font-medium">
                      Require mobile OTP confirmation for admin login
                    </span>
                  </div>
                </div>
              </div>
            ...
            {activeTab === "automation" && (
              <div className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  <span className="text-[10px] text-slate-500 block">
                    Interpolation keys supported: <code>{`{workerName}`}</code>,{" "}
                    <code>{`{date}`}</code>, <code>{`{status}`}</code>.
                  </span>
                </div>
              </div>
            )}
