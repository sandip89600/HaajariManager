      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Audit, configure, and onboard client construction tenants
          </p>
        </div>
        <button
          onClick={() => {
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-850 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white">
              {
                orgs.filter(
                  (o) => o.plan === "business" || o.plan === "professional",
                ).length
              }
            </h3>
          </div>
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        onClick={() => {
                          if (
                            window.confirm(
                              `Are you sure you want to delete organization "${org.name}" and all associated workers, projects, and data?`,
                            )
                          ) {
