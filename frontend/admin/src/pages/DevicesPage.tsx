...
export default function DevicesPage() {
  ...
  const [activeTab, setActiveTab] = useState<"terminals" | "security_events">(
    "terminals",
  );
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Audit registered supervisor terminals, login activity, and
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-850 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white">
              {
                securityEvents.filter((e) => e.eventType === "NEW_DEVICE_LOGIN")
                  .length
              }{" "}
              Logins
            </h3>
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-850 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-rose-450">
              {
                securityEvents.filter((e) => e.status === "marked_suspicious")
                  .length
              }{" "}
              Alerts
            </h3>
      ...
      <div className="glass-card p-4 rounded-2xl border border-slate-850">
        <div className="relative">
          ...
          <input
            ...
            placeholder={
              activeTab === "terminals"
                ? "Search by device model, device ID, or contractor company..."
                : "Search by user, device name, location, or event type..."
            }
            value={search}
                ...
                {filteredDevices.length > 0 ? (
                  filteredDevices.map((d) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 font-semibold text-slate-400 tracking-widest">
                        {d.deviceId}
                      </td>
                      ...
                      <td className="px-6 py-4">
                        {d.biometricEnrolled ? (
                          <span className="text-xs text-emerald-450 font-bold uppercase tracking-wider">
                            ✔ Enrolled
                          </span>
                        ) : (
