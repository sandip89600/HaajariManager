            ...
            <div className="flex-1 px-4 py-4 overflow-y-auto space-y-1">
              {menuItems.map((item) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      className={`w-4 h-4 ${isActive ? "text-orange-500" : "text-slate-400"}`}
                    />
                    {item.name}
                  </Link>
                );
            ...
            <div className="p-4 border-t border-slate-850/40 bg-slate-900/20">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-bold text-white truncate group-hover:text-orange-500 transition-all">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto max-h-screen">
        ...
        <header className="bg-slate-950 border-b border-slate-850/40 h-16 flex items-center justify-between px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-2.5 max-h-64 overflow-y-auto">
                      <div className="p-2.5 hover:bg-slate-850/30 rounded-xl border border-slate-850/50 transition-colors">
                        ...
                        <p className="text-[11px] text-slate-400 leading-normal">
                          Client Organization 'Shree Builders' reached limit of
                          20 workers.
                        </p>
                      </div>
                      <div className="p-2.5 hover:bg-slate-850/30 rounded-xl border border-slate-850/50 transition-colors">
                        ...
                        <p className="text-[11px] text-slate-400 leading-normal">
                          Client 'Vikas Constructions' upgraded to Premium Plan
                          (Annual).
                        </p>
                      </div>
                    </div>
            ...
            >
              <span className="text-xs font-semibold text-slate-300 hidden sm:inline group-hover:text-orange-500 transition-all">
