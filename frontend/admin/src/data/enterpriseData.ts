export const kpiCards = [
  {
    ...
    delta: "+12.4%",
    tone: "positive",
    detail: "Across 6 active regions",
  },
  {
    label: "Total Workers",
    value: "2,840",
    delta: "+8.1%",
    tone: "positive",
    detail: "Daily attendance synced",
  },
  {
    label: "Present Today",
    value: "2,312",
...
export const activityFeed = [
  {
    ...
    detail: "Northstar Tower • 144 workers marked present",
    time: "2 min ago",
    tone: "success",
  },
  {
    title: "Payment posted",
    detail: "Apex Builders • ₹1,24,000 salary batch cleared",
    time: "11 min ago",
    tone: "info",
  },
  {
    title: "Worker added",
    detail: "Kiran Rao onboarded to Riverfront Site",
    time: "28 min ago",
    tone: "warning",
  },
  {
    title: "Site milestone",
    detail: "Greenline Plaza reached 78% completion",
    time: "44 min ago",
    tone: "success",
  },
];
...
export const workerRows = [
  {
    name: "Suresh Bhatia",
    trade: "Civil Supervisor",
    site: "Northstar Tower",
    status: "Present",
    attendance: "On Time",
  },
  {
...
export const reportCards = [
  {
    ...
    description: "Daily and monthly attendance summaries",
    tag: "Live",
  },
  {
    title: "Worker Report",
    description: "Skill mix, payroll and shift patterns",
    tag: "Updated",
  },
  {
    title: "Site Report",
    description: "Milestones, safety and budget health",
    tag: "Exportable",
  },
];
...
export const settingsSections = [
  {
    ...
    detail: "Brand, legal name and operational contacts",
  },
  {
    title: "Notifications",
    detail: "Alerts for payments, attendance and site milestones",
  },
  {
    title: "Security",
    detail: "JWT expiry, session limits and device approvals",
  },
];
